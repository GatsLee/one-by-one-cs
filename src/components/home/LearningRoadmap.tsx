...
const EDGES: Edge[] = [
  // Phase 1 internal
  { id: "e-ds-os", source: "01-data-structures", target: "02-os", ...edgeDefaults },
  { id: "e-ds-net", source: "01-data-structures", target: "03-network", ...edgeDefaults },
  { id: "e-os-net", source: "02-os", target: "03-network", ...edgeDefaults },

  // Phase 1 → Phase 2
  { id: "e-ds-db", source: "01-data-structures", target: "04-database", ...edgeDefaults, animated: true, style: { stroke: "#3a8f5a", strokeWidth: 2 } },
  ...
  // Phase 2 → Phase 3
  { id: "e-db-sd", source: "04-database", target: "05-system-design", ...edgeDefaults, animated: true, style: { stroke: "#a63a3a", strokeWidth: 2 } },
  { id: "e-arch-sd", source: "09-architecture", target: "05-system-design", ...edgeDefaults, animated: true, style: { stroke: "#a63a3a", strokeWidth: 2 } },
  { id: "e-arch-infra", source: "09-architecture", target: "07-infra", ...edgeDefaults },
  { id: "e-net-infra", source: "03-network", target: "07-infra", ...edgeDefaults },

  // Phase 3 → Phase 4
  { id: "e-sd-ai", source: "05-system-design", target: "06-ai", ...edgeDefaults, animated: true, style: { stroke: "#1e2b42", strokeWidth: 2 } },
  { id: "e-infra-agent", source: "07-infra", target: "08-ai-agent", ...edgeDefaults, animated: true, style: { stroke: "#1e2b42", strokeWidth: 2 } },
  { id: "e-ai-agent", source: "06-ai", target: "08-ai-agent", ...edgeDefaults, style: { stroke: "#1e2b42", strokeWidth: 2 } },
];
